...
| REL | FR-2, FR-3, FR-4, FR-8 | Centralize note path mutations, refresh state after writes, and verify undo coverage with tests |
...
- Sidebar and store tests for note creation, rename, move, and active note synchronization.
